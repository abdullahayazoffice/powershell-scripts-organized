...
foreach ($subscription in $subscriptions)
{
    ...
    foreach($webApp in $webApps){
        ...
        # getting the details of authentications
        $authenticationstatus = az webapp auth show --name $webApp --resource-group MyResourceGroup
        ...
        # this is to show the authentication of the websites
        $webAppObj.Authenticationsstatus =  $authenticationstatus
